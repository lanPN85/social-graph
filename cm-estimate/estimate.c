...
#define MCSWEEPS 30000   // Number of Monte Carlo sweeps
#define SAMPLE 5         // Interval at which to print out results, in sweeps
...
main(int argc, char *argv[])
{
  ...
  fprintf(stderr,"Creating lookup table...\n");
  maketable();

  // Initialize the group assignment
  fprintf(stderr,"Initializing groups...\n");
  initgroups();

  // Perform the Monte Carlo
  fprintf(stderr,"Starting Monte Carlo...\n");
